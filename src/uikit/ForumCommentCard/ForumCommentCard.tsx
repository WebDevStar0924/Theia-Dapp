import { ForumCommentCardWrapper } from './styles'
...
import { ForumSubCommentCard } from 'uikit/ForumSubCommentCard'
        ...
        <ForumCommentCardWrapper>
          ...
          {visibleReplyBox && (
            <div>
              <div
                className={'underLine'}
                style={{ margin: '10px -13px 0px -13px' }}
              ></div>
          ...
          <div>
            <div
              ...
              style={{ margin: '10px -13px 0px -13px' }}
            ></div>
            <ForumSubCommentCard></ForumSubCommentCard>
          </div>
        </ForumCommentCardWrapper>
      }
    </>
