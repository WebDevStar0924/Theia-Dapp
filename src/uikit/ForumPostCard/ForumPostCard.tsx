...
export default function ForumPostCard() {
  ...
  const gifUrl = "https://camo.githubusercontent.com/e4a569755580f96dce0e6d65bc761e0d9aef0fecae524ec73a1b0be60fc934fa/68747470733a2f2f7777772e6d79676f2e67652f75706c6f6164732f626c6f672f313538343032333739352e6a7067"
  return (
    <ForumPostCardWrapper>
      ...
      <Flex className={'rightPart'} flexDirection="column">
        ...
        <Flex className={'postContext'}>
          {postTextList[getRandomInt(2)]}
        </Flex>
        <Flex className={'imageLayout'} flexDirection="row">
          {postMedia.map((value, index) => {
            return mediaCount == 3 && index == 2 ?
              <img src={defaultProjectBanner} style={{ width: '270px', height: '400px', gridRowStart: '1', gridRowEnd: '3' }} ></img>
              : <img src={index == 0 ? gifUrl : defaultProjectBanner} style={{ width: mediaCount == 1 ? '550px' : '270px', height: mediaCount == 1 ? '360px' : mediaCount == 2 ? '288px' : mediaCount == 3 && index == 2 ? '288px' : '195px' }} ></img>
          })}
        </Flex>
        <Flex
          flexDirection="row"
