...
export default function CollectiveFeedPost() {
  ...
  useEffect(() => {
    if (currentMediaCount < 4 && selectedGif != undefined && selectedGif != null && alreadyGifOpend == false) {
      setCurrentMediaCount(currentMediaCount + 1)
      ...
      <Flex className="formLayout">
        ...
        {visibleImageUploadForm && currentMediaCount != 0 && (
          <Flex
            ...
            style={{ width: '562px', height: currentMediaCount > 1 ? '296px' : '512px' }}
          >
            {photoList.map((item, idx) => {
              return (
                currentMediaCount == 3 && alreadyGifOpend == false && idx == 2 ?
                  <Flex className="imageCard" id={'image' + { idx }} style={{ gridRowStart: '1', gridRowEnd: '3' }}>
                    <IconButtonV2
                    ...
                    <img src={item} style={{ width: '269px', height: '288px' }}></img>
                  </Flex> : <Flex className="imageCard" id={'image' + { idx }} >
                    <IconButtonV2
                      className="closeImageButton"
                      onClick={() => {
                        removePhotoItem(idx)
                    ...
                    {currentMediaCount == 1 &&
                      <img src={item} style={{ width: '546px', height: '504px' }}></img>}
                    {currentMediaCount == 2 &&
                      <img src={item} style={{ width: '269px', height: '288px' }}></img>}
                    {currentMediaCount == 3 &&
                      <img src={item} style={{ width: '269px', height: '144px' }}></img>}
                    {currentMediaCount == 4 &&
                      <img src={item} style={{ width: '269px', height: '144px' }}></img>}
                  </Flex>
            ...
            {selectedGif != undefined && selectedGif != null && currentMediaCount == 3 && (
              <Flex className="imageCard" style={{ gridRowStart: '1', gridRowEnd: '3' }}>
                <IconButtonV2
                  className="closeImageButton"
                  onClick={() => {
                    removeGif()
                ...
                <img src={selectedGif['images']['downsized']['url']} style={{ height: '320px', width: '269px' }} />
              </Flex>
            )}
            {selectedGif != undefined && selectedGif != null && currentMediaCount == 2 && (
            ...
            {selectedGif != undefined && selectedGif != null && currentMediaCount == 1 && (
              <Flex className="imageCard">
                <IconButtonV2
                  className="closeImageButton"
                  onClick={() => {
                ...
                <img src={selectedGif['images']['downsized']['url']} style={{ height: '504px', width: '546px' }} />
              </Flex>
            )}
            {selectedGif != undefined && selectedGif != null && currentMediaCount == 4 && (
              <Flex className="imageCard">
                <IconButtonV2
                  className="closeImageButton"
                  onClick={() => {
                ...
                <img src={selectedGif['images']['downsized']['url']} style={{ height: '140px', width: '269px' }} />
              </Flex>
            )}
