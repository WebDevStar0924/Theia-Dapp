...
const Modal = ({ investConfirmModal, setInvestConfirmModal }) => {
  const modalRef = useRef()
  const closeModal = (e) => {
    if (modalRef.current === e.target) {
      setInvestConfirmModal(false)
    }
  }
  ...
  const keyPress = useCallback(
    (e) => {
      if (e.key === 'Escape' && investConfirmModal) {
        setInvestConfirmModal(false)
      }
    },
    [setInvestConfirmModal, investConfirmModal],
  )
          ...
          <motion.div variants={modal} className="modal">
            ...
            <div className="modal-calculate-container">
              ...
              <div className="modal-calculate-items">
                ...
                <div className="modal-calculate-items-right">$700,001,4</div>
              </div>
            </div>
